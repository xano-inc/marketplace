...
Finds the index of the last element in an array that matches the specified criteria.
...
| `from_index` | int | No | The index to start searching from (searches backwards) |
...
```json
{
  "collection": [{"id": 1}, {"id": 2}, {"id": 2}, {"id": 3}],
  "path": "id",
  "value": 2
}
```
